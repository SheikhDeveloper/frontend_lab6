    ...
    <div class="container">
      ...
      <div class="controls">
        <div class="control-buttons">
          <router-link to="/lab14/add" class="btn btn-primary">Add Task</router-link>
          <router-link to="/lab14/about" class="btn btn-secondary">About</router-link>
      ...
      <div v-else class="task-list-items">
        <div v-for="task in tasks" :key="task.id" class="task-item" :class="{ completed: task.completed }">
          <div class="task-info">
            ...
            <div class="details">
              <h3>
                <router-link :to="`/lab14/task/${task.id}`" class="task-link">
                  {{ task.title }}
                </router-link>
              </h3>
